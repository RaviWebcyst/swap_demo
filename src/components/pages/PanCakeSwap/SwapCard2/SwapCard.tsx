...
const SwapCard = () => {
  ...
  const handleGetFeeAmountsData = async (
    ...
    const rezorValue = await getRezorAmountsOutfunction(data);

    console.log(rezorValue, "rezorValue");
      ...
      <div className="addCardBox d-md-flex justify-content-center gap-md-5">
        <div className="addCardBox_swap">
          ...
          <div className="addCard">
            <div className="addCard_tokenvalues d-flex gap-3">
              <ActiveTokenCard
                field="Field1"
              ...
              />
              <div className="swapbt mt-4 pt-3">
            ...
            <div className="sendInput mt-4 pt-2">
              <h4><span className="input_label ms-3">Send </span> </h4>
              <div className="input_send_field mt-3">
                <div className="d-flex align-items-center gap-2">
                  <img src="assets/images/swap_reciev/Bitcoin_send.svg" />
                  <div>
                    <h6 className="font-geist fw-bold">0</h6>
                    <p className="fw-medium font-geist">$0.00</p>
                  </div>
                </div>
              </div>
            </div>

            <div className="sendToWallet mt-4 pt-4">
              <h4><span className="input_label ms-3 pt-2">Send to wallet </span> </h4>
              <div className="input_send_field mt-3">
                <div className="d-flex align-items-center gap-2">
                  <img src="assets/images/swap_reciev/metamask_btc.svg" />
                  <div>
                    <h6 className="font-geist fw-bold">MetaMask</h6>
                    <p className="fw-medium font-geist">0x96v78...300283</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="get_bsc_gas mt-5">
              <Form>
                <div className="d-flex justify-content-between align-items-center">
                  <div className="d-flex align-items-center gap-3">
                    <img src="assets/images/swap_reciev/green-gas-station.svg" />
                    <h5 className="fw-semibold font-geist">Get BSC gas</h5>
                  </div>
                  ...
                  <Form.Check // prettier-ignore
                    ...
                    aria-expanded={open}
                    className="toggle_switch_button"
                  />
                </div>
              </Form>
              <Collapse in={open}>
                <div id="example-collapse-text font-geist" className="bsc_gas_description ps-5 ms-3 mt-2">
                  You're low on BSC gas. By continuing, you'll get<br /> enough gas to complete the transaction.
                </div>
              </Collapse>
            </div>

            <div className="enough_fund_msg mt-5">
              <div className="d-flex gap-4 align-items-center">
                <img src="assets/images/swap_reciev/enough-fund-circle.svg" alt="" />
                <p className="font-geist">You don't have enough funds to complete the<br /> transaction.</p>
              </div>
            </div>
            ...
            <div className={`p-3 seticon-bg`}>
              ...
              <div className="time_left">
                <div className="d-flex gap-3 align-items-center justify-content-center">
                  <img src="assets/images/swap_reciev/refresh-circle.svg" />
                  <p className="time_second font-geist">59s left</p>
                </div>
              </div>
            </div>
          </div>
                ...
                <div className="first_value_div pt-3">
                  <Accordion>
                    <Accordion.Item eventKey="0" className="border-0">
                      <Accordion.Header>
                        <div className="d-flex align-items-center gap-3">
                          <img src="assets/images/swap_reciev/Bitcoin.png" />
