...
import quoteABI from "../abi/quote.json";
...
export const BSC_CONTRACT_LIST =
  envType !== "production"
    ? {
      router: {
        address: "0xbB22f3800873222122fe6F5df88cDeC41fDA95e2",
        Block: 6615558,
        abi: routerABI,
      },
      panCakeSwap: {
      ...
      factory: {
        address: "0x865ba7E55909b55Dfb24879DA91cFBE0af04ACC8",
        blockNumber: 6430279,
        abi: factoryABI,
      },
      panRouter: {
    ...
    : {
      router: {
        address: "0x4D412972f4fCe736F1E5a1425De7495419a4CBa4",
        Block: 6615558,
        abi: routerABI,
      },
      panCakeSwap: {
      ...
      factory: {
        address: "0x3D36c450fDbFB4E483D9E9Cf44f78989dEA429B0",
        blockNumber: 6430279,
        abi: factoryABI,
      },
      panRouter: {
